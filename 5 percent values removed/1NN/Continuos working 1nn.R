...
msse <- get_mse(xn)
write.csv(xn,'W:\\cases\\Question 1\\5 percent values removed\\1NN\\MyData_continuous_1nn_5percent.csv', row.names = TRUE)
write.table(msse, 'W:\\cases\\Question 1\\5 percent values removed\\1NN\\MyData_continuous_1nn_5percent.csv', col.names=FALSE, sep=",", append=TRUE)
