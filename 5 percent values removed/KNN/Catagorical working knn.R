...
accu_d <- accuracy(x)
write.csv(x,'W:\\cases\\Question 1\\5 percent values removed\\KNN\\MyData_catagorical_1nn_5percent.csv', row.names = TRUE)
write.table(accu_d, 'W:\\cases\\Question 1\\5 percent values removed\\KNN\\MyData_catagorical_1nn_5percent.csv', col.names=FALSE, sep=",", append=TRUE)
