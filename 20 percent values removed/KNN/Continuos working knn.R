...
msse <- get_mse(xn)
write.csv(xn,'W:\\cases\\Question 1\\20 percent values removed\\KNN\\MyData_continuous_knn_20percent.csv', row.names = TRUE)
write.table(msse, 'W:\\cases\\Question 1\\20 percent values removed\\KNN\\MyData_continuous_knn_20percent.csv', col.names=FALSE, sep=",", append=TRUE)
