...
accu_d <- accuracy(x)
write.csv(x,'W:\\cases\\Question 1\\20 percent values removed\\1NN\\MyData_catagorical_1nn_20percent.csv', row.names = TRUE)
write.table(accu_d, 'W:\\cases\\Question 1\\20 percent values removed\\1NN\\MyData_catagorical_1nn_20percent.csv', col.names=FALSE, sep=",", append=TRUE)
