...
msse <- get_mse(xn)
write.csv(xn,'W:\\cases\\Question 1\\20 percent values removed\\KNN weighted\\MyData_continuous_knnw_20percent.csv', row.names = TRUE)
write.table(msse, 'W:\\cases\\Question 1\\20 percent values removed\\KNN Weighted\\MyData_continuous_knnw_20percent.csv', col.names=FALSE, sep=",", append=TRUE)
