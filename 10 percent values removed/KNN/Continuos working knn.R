...
msse <- get_mse(xn)
write.csv(xn,'W:\\cases\\Question 1\\10 percent values removed\\KNN\\MyData_continuous_1nn_10percent.csv', row.names = TRUE)
write.table(msse, 'W:\\cases\\Question 1\\10 percent values removed\\KNN\\MyData_continuous_1nn_10percent.csv', col.names=FALSE, sep=",", append=TRUE)
